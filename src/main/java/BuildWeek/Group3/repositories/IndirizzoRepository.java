...
public interface IndirizzoRepository extends JpaRepository<Indirizzo, UUID> {
    ...
    List<Indirizzo> findByCliente_IdClienteAndTipoIndirizzo(UUID idCliente, String tipoIndirizzo);
    List<Indirizzo> findByCliente_IdClienteAndComune_IdComune(UUID idCliente, UUID idComune);
}